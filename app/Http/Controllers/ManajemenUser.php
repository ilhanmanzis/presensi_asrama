...
class ManajemenUser extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin/manajemen/create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            //'role' => 'required|in:admin,finance,gudang', // Validasi role, hanya admin atau karyawan
        ...
        User::create([
            ...
            //'role' => $validated['role'],
            'role' => 'pembina', // Default role sebagai pembina
            'foto' => $imagePath,
        ]);
    ...
    public function show(string $id)
    {
        ...
        return view('admin/manajemen/show', $data);
    }
