    ...
    <div class="p-8">
        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <form action="{{ route('pembina.santri-jamaah.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!-- Elements -->
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="waktu" required value="{{ old('waktu') }}"
                                    ...
                                    <option {{ old('waktu') === 'subuh' ? 'selected' : '' }} value="subuh"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Subuh
                                    </option>
                                    <option {{ old('waktu') === 'dzuhur' ? 'selected' : '' }} value="dzuhur"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Dzuhur
                                    </option>
                                    <option {{ old('waktu') === 'ashar' ? 'selected' : '' }} value="ashar"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Ashar
                                    </option>
                                    <option {{ old('waktu') === 'maghrib' ? 'selected' : '' }} value="maghrib"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Maghrib
                                    </option>
                                    <option {{ old('waktu') === 'isya' ? 'selected' : '' }} value="isya"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Isya
                                    </option>
