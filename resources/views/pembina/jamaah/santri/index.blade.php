                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $jamaah->presensiJamaahSantris->where('status', 'hadir')->count() }}
                                                                    hadir
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('pembina.santri-jamaah.delete', ['id' => $jamaah['id_jamaah_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-jamaah.show', ['id' => $jamaah['id_jamaah_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-jamaah.detail', ['id' => $jamaah['id_jamaah_santri']]) }}"
