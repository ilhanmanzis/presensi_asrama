        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between">
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                    Data Jamaah Santriwati
                </h3>
            </div>
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <form
                    action="{{ route('pembina.santriwati-jamaah.update', ['id' => $jamaah['id_jamaah_santriwati']]) }}"
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Waktu Sholat<span class="text-error-500">*</span>
                            </label>
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="waktu" required value="{{ $jamaah['waktu'] }}"
                                    ...
                                    <option {{ $jamaah['waktu'] === 'subuh' ? 'selected' : '' }} value="subuh"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Subuh
                                    </option>
                                    <option {{ $jamaah['waktu'] === 'dzuhur' ? 'selected' : '' }} value="dzuhur"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Dzuhur
                                    </option>
                                    <option {{ $jamaah['waktu'] === 'ashar' ? 'selected' : '' }} value="ashar"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Ashar
                                    </option>
                                    <option {{ $jamaah['waktu'] === 'maghrib' ? 'selected' : '' }} value="maghrib"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Maghrib
                                    </option>
                                    <option {{ $jamaah['waktu'] === 'isya' ? 'selected' : '' }} value="isya"
                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                        Isya
                                    </option>
                        ...
                        <div class="max-w-full overflow-x-auto">
                            <table class="min-w-full">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @foreach ($jamaah->presensiJamaahSantriwatis as $index => $presensi)
                                        <tr>
