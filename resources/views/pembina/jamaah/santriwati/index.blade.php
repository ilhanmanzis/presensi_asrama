                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5">
                            <a href="{{ route('pembina.santriwati-jamaah.create') }}"
                                class="inline-flex items-center gap-2 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600">
                                Tambah Data
                            </a>
                            <form action="{{ route('pembina.santriwati-jamaah') }}" method="get">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $jamaah->presensiJamaahSantriwatis->where('status', 'hadir')->count() }}
                                                                    hadir
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('pembina.santriwati-jamaah.delete', ['id' => $jamaah['id_jamaah_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santriwati-jamaah.show', ['id' => $jamaah['id_jamaah_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santriwati-jamaah.detail', ['id' => $jamaah['id_jamaah_santriwati']]) }}"
