                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('pembina.santri-alquran.create', ['id' => $kelompok->id_alquran_santri]) }}"
                            ...
                            <form action="{{ route('pembina.santri-alquran.show', $kelompok->id_alquran_santri) }}"
                                method="get">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('pembina.santri-alquran.delete', ['alquranId' => $kelompok['id_alquran_santri'], 'id' => $alquran['id_data_alquran_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-alquran.edit', ['alquranId' => $kelompok['id_alquran_santri'], 'id' => $alquran['id_data_alquran_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-alquran.detail', ['alquranId' => $kelompok['id_alquran_santri'], 'id' => $alquran['id_data_alquran_santri']]) }}"
