<x-layout>
    ...
    <main>
        <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
            <!-- Breadcrumb Start -->
            <div x-data="{ pageName: `{{ $title . ', Kelompok : ' . $kelompok->name }}` }">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('pembina.santriwati-alquran.create', ['id' => $kelompok->id_alquran_santriwati]) }}"
                            ...
                            <form
                                action="{{ route('pembina.santriwati-alquran.show', $kelompok->id_alquran_santriwati) }}"
                                method="get">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $alquran->presensi->where('status', 'hadir')->count() }}
                                                                    hadir
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('pembina.santriwati-alquran.delete', ['alquranId' => $kelompok['id_alquran_santriwati'], 'id' => $alquran['id_data_alquran_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santriwati-alquran.edit', ['alquranId' => $kelompok['id_alquran_santriwati'], 'id' => $alquran['id_data_alquran_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santriwati-alquran.detail', ['alquranId' => $kelompok['id_alquran_santriwati'], 'id' => $alquran['id_data_alquran_santriwati']]) }}"
