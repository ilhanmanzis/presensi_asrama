                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('pembina.santri-bandongan.create') }}"
                            ...
                            <form action="{{ route('pembina.santri-bandongan') }}" method="get">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('pembina.santri-bandongan.delete', ['id' => $bandongan['id_bandongan_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-bandongan.show', ['id' => $bandongan['id_bandongan_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-bandongan.detail', ['id' => $bandongan['id_bandongan_santri']]) }}"
