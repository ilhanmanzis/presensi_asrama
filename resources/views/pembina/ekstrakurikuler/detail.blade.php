                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $dataEkstrakurikuler->ekstrakurikuler->name }}" readonly
                                disabled
                                        ...
                                        <tr>
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex -space-x-2">
                                                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                            {{ $presensi->santri->nis ?? $presensi->santriwati->nis }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-5 py-4 sm:px-6">
                                                <div class="flex items-center">
                                                    <div class="flex -space-x-2">
                                                        <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                            {{ $presensi->santri->name ?? $presensi->santriwati->name }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
