    ...
    <div class="p-8">
        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <form action="{{ route('pembina.ekstrakurikuler.store') }}" method="post"
                        ...
                        <div>
                            ...
                            <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                <select name="id_ekstrakurikuler" required
                                    class="dark:bg-dark-900 shadow-theme-xs  focus:ring-brand-500/10  h-11 w-full appearance-none rounded-lg border bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 {{ $errors->has('ekstrakurikuler') ? 'border-error-300 focus:border-error-300 dark:border-error-700 dark:focus:border-error-800' : 'border-gray-300 focus:border-brand-300 dark:border-gray-700' }}"
                                    :class="isOptionSelected && 'text-gray-800 dark:text-white/90'"
                                    @change="isOptionSelected = true">
                                    @foreach ($ekstrakurikulers as $ekstrakurikuler)
                                        <option
                                            {{ old('ekstrakurikuler') === $ekstrakurikuler['id_ekstrakurikuler'] ? 'selected' : '' }}
                                            value="{{ $ekstrakurikuler['id_ekstrakurikuler'] }}"
                                                    ...
                                                    <div class="flex -space-x-2 w-full">
                                                        <div x-data="{ isOptionSelected: false }"
                                                            ...
                                                            <select name="status_santri[]" required
                                                                ...
                                                                @change="isOptionSelected = true">
                                                                <option
                                                                    {{ old('status_santri.' . $index) === 'hadir' ? 'selected' : '' }}
                                                                    value="hadir">Hadir</option>
                                                                <option
                                                                    {{ old('status_santri.' . $index) === 'izin' ? 'selected' : '' }}
                                                                    value="izin">Izin</option>
                                                                <option
                                                                    {{ old('status_santri.' . $index) === 'sakit' ? 'selected' : '' }}
                                                                    value="sakit">Sakit</option>
                                                                <option
                                                                    {{ old('status_santri.' . $index) === 'alpha' ? 'selected' : '' }}
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex -space-x-2  w-full">
                                                        <input type="text" name="catatan_santri[]"
                                                            value="{{ old('catatan_santri.' . $index) }}"
                                                    ...
                                                    <div class="flex -space-x-2 w-full">
                                                        <div x-data="{ isOptionSelected: false }"
                                                            ...
                                                            <select name="status_santriwati[]" required
                                                                ...
                                                                @change="isOptionSelected = true">
                                                                <option
                                                                    {{ old('status_santriwati.' . $index) === 'hadir' ? 'selected' : '' }}
                                                                    value="hadir">Hadir</option>
                                                                <option
                                                                    {{ old('status_santriwati.' . $index) === 'izin' ? 'selected' : '' }}
                                                                    value="izin">Izin</option>
                                                                <option
                                                                    {{ old('status_santriwati.' . $index) === 'sakit' ? 'selected' : '' }}
                                                                    value="sakit">Sakit</option>
                                                                <option
                                                                    {{ old('status_santriwati.' . $index) === 'alpha' ? 'selected' : '' }}
                                                                    value="alpha">Alpha</option>
                                                            </select>
                                                            <span
                                                                class="pointer-events-none absolute top-1/2 right-4 z-30 -translate-y-1/2 text-gray-500 dark:text-gray-400">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex -space-x-2  w-full">
                                                        <input type="text" name="catatan_santriwati[]"
                                                            value="{{ old('catatan_santriwati.' . $index) }}"
                                                            class="dark:bg-dark-900 shadow-theme-xs  focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border  bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 border-gray-300 focus:border-brand-300 dark:border-gray-700" />
                                                    </div>
                                                </div>
                                            </td>
