                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5">
                            <a href="{{ route('pembina.ekstrakurikuler.create') }}"
                                class="inline-flex items-center gap-2 px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-brand-500 shadow-theme-xs hover:bg-brand-600 lg:mb-5 md:mb-5 sm:mb-0">
                                Tambah Data
                            </a>
                            <form action="{{ route('pembina.ekstrakurikuler') }}" method="get">
                                        ...
                                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                            <select name="ekstrakurikuler"
                                                ...
                                                @foreach ($datas as $data)
                                                    <option value="{{ $data['id_ekstrakurikuler'] }}"
                                                        {{ request('ekstrakurikuler') == $data['id_ekstrakurikuler'] ? 'selected' : '' }}
                                                        class="text-gray-700 dark:bg-gray-900 dark:text-gray-400 ">
                                                        {{ $data['name'] }}
                                                    </option>
                                                @endforeach
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $ekstrakurikuler->ekstrakurikuler->name }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $ekstrakurikuler->presensi->filter(function ($p) {
                                                                            return $p->status === 'hadir' && $p->id_santri !== null;
                                                                        })->count() +
                                                                        $ekstrakurikuler->presensi->filter(function ($p) {
                                                                                return $p->status === 'hadir' && $p->id_santriwati !== null;
                                                                            })->count() }}
                                                                    hadir
                                                                </p>
                                                            </div>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('pembina.ekstrakurikuler.delete', ['id' => $ekstrakurikuler['id_data_ekstrakurikuler']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.ekstrakurikuler.show', ['id' => $ekstrakurikuler['id_data_ekstrakurikuler']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.ekstrakurikuler.detail', ['id' => $ekstrakurikuler['id_data_ekstrakurikuler']]) }}"
