                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('pembina.santri-kitab.create', ['id' => $kelompok->id_kitab_santri]) }}"
                            ...
                            <form action="{{ route('pembina.santri-kitab.show', $kelompok->id_kitab_santri) }}"
                                method="get">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('pembina.santri-kitab.delete', ['kitabId' => $kelompok['id_kitab_santri'], 'id' => $kitab['id_data_kitab_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-kitab.edit', ['kitabId' => $kelompok['id_kitab_santri'], 'id' => $kitab['id_data_kitab_santri']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santri-kitab.detail', ['kitabId' => $kelompok['id_kitab_santri'], 'id' => $kitab['id_data_kitab_santri']]) }}"
