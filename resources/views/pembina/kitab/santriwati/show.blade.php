        ...
        <div class=" mx-5 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="px-5 py-4 sm:px-6 sm:py-5 flex justify-between">
                <h3 class="text-base font-medium text-gray-800 dark:text-white/90">
                    Data Sorogan Kitab Santriwati
                </h3>
            </div>
            <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                <form
                    action="{{ route('pembina.santriwati-kitab.update', ['kitabId' => $kelompok['id_kitab_santriwati'], 'id' => $kitab['id_data_kitab_santriwati']]) }}"
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="kegiatan" value="{{ $kitab['kegiatan'] }}"
                        ...
                        <div class="max-w-full overflow-x-auto">
                            <table class="min-w-full">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @foreach ($kitab->presensi as $index => $presensi)
                                        <tr>
