                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('pembina.santriwati-kitab.create', ['id' => $kelompok->id_kitab_santriwati]) }}"
                            ...
                            <form action="{{ route('pembina.santriwati-kitab.show', $kelompok->id_kitab_santriwati) }}"
                                method="get">
                                            ...
                                            @foreach ($kitabs as $kitab)
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $kitab->presensi->where('status', 'hadir')->count() }}
                                                                    hadir
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            <form
                                                                action="{{ route('pembina.santriwati-kitab.delete', ['kitabId' => $kelompok['id_kitab_santriwati'], 'id' => $kitab['id_data_kitab_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santriwati-kitab.edit', ['kitabId' => $kelompok['id_kitab_santriwati'], 'id' => $kitab['id_data_kitab_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('pembina.santriwati-kitab.detail', ['kitabId' => $kelompok['id_kitab_santriwati'], 'id' => $kitab['id_data_kitab_santriwati']]) }}"
