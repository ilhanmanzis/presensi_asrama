                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('admin.santriwati-kitab.create') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            {{-- <form
                                                                action="{{ route('admin.santriwati-kitab.delete', ['id' => $kitab['id_kitab_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('admin.santriwati-kitab.show', ['id' => $kitab['id_kitab_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('admin.santriwati-kitab.anggota', ['id' => $kitab['id_kitab_santriwati']]) }}"
