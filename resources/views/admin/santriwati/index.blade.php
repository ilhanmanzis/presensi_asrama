                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('admin.santriwati.create') }}"
                            ...
                            <form action="{{ route('admin.santriwati') }}" method="get">
                                <div class="flex justify-between mb-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" placeholder="cari nama atau nis..." id="search-input"
                                            name="santriwati" value="{{ request('santriwati') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $santriwati->asrama->name ?? 'Tidak ada' }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="px-5 py-4 sm:px-6">
                                                        <div class="flex items-center">
                                                            <div class="flex -space-x-2">
                                                                <p
                                                                    class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                                    {{ $santriwati->kelas->name ?? 'Tidak ada' }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('admin.santriwati.delete', ['id' => $santriwati['id_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('admin.santriwati.show', ['id' => $santriwati['id_santriwati']]) }}"
