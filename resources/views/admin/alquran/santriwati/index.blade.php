                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    <div class="px-5 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between gap-5">
                            <a href="{{ route('admin.santriwati-alquran.create') }}"
                                ...
                                Tambah Kelompok Sorogan Al-Quran
                            </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            {{-- <form
                                                                action="{{ route('admin.santriwati-alquran.delete', ['id' => $alquran['id_alquran_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('admin.santriwati-alquran.show', ['id' => $alquran['id_alquran_santriwati']]) }}"
                                                            ...
                                                            <a href="{{ route('admin.santriwati-alquran.anggota', ['id' => $alquran['id_alquran_santriwati']]) }}"
