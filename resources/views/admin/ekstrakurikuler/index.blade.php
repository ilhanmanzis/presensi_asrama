                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-5 py-4 sm:px-6">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <form
                                                                action="{{ route('admin.ekstrakurikuler.delete', ['id' => $ekstrakurikuler['id_ekstrakurikuler']]) }}"
                                                            ...
                                                            <a href="{{ route('admin.ekstrakurikuler.show', ['id' => $ekstrakurikuler['id_ekstrakurikuler']]) }}"
