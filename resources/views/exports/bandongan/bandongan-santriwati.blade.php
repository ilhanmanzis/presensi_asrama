        ...
        <tbody>
            @foreach ($data['santriwatis'] as $index => $santriwati)
                <tr>
                    ...
                    <td valign="center" align="left">{{ $santriwati['nama'] }}</td>
                    <td valign="center" align="center">{{ $santriwati['hadir'] }}</td>
                    <td valign="center" align="center">{{ $santriwati['sakit'] }}</td>
                    <td valign="center" align="center">{{ $santriwati['izin'] }}</td>
                    <td valign="center" align="center">{{ $santriwati['alpha'] }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
