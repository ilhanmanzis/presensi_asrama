<header x-data="{ menuToggle: false }"
    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.html" class="lg:hidden flex justify-start">
                <img class="size-10 dark:hidden" src="{{ asset('storage/logo/' . $profile['logo']) }}" alt="Logo" />
                <img class="size-10 hidden dark:block" src="{{ asset('storage/logo/' . $profile['logo']) }}"
                    alt="Logo" />
                <span class="text-xl font-semibold mt-2 mx-2 dark:text-white/90">{{ $profile['name'] }}</span>
            </a>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ asset('storage/') }}/user/{{ auth()->user()->foto ?? 'default.jpg' }}"
                            alt="User" />
                    </span>
